...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('group_user', sa.Column('student_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'group_user', type_='foreignkey')
    op.create_foreign_key('group_user_ibfk_2', 'group_user', 'user', ['student_id'], ['id'])
