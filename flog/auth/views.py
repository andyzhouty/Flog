...
def register():
    ...
    if request.method == "POST":
        if (
            ...
            or request.form["username"] is None
...
def login():
    ...
    if request.method == "POST":
        user_by_username = User.query.filter_by(username=request.form["user"]).first()
        user_by_email = User.query.filter_by(email=request.form["user"].lower()).first()
